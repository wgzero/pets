  ...
  <div class="categoryDetail">
    ...
    <div class="cate-detail-info">
      <div class="cate-detail-money">
        <div class="cate-detail-left">
          <div class="cate-money">￥500</div>
          <div class="cate-price">价格 ￥599</div>
        </div>
    ...
    <div class="cate-send">
      <div class="cate-send-all">
        ...
        <div class="cate-send-right">
          ...
          <div class="cate-send-address">月销量: 100</div>
        </div>
      </div>
    </div>
    <div class="cate-content-info">
      <div class="cate-content-top">
    ...
    <div class="cate-footer">
      <van-action-bar>
        ...
        <van-action-bar-button color="#F5A636" type="warning" text="加入购物车" />
